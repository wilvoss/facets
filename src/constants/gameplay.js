export async function loadGameplayModules() {
  ...
  const Science = new WordSetObject({ id: '7', emoji: '🧪', name: 'Science', data: ['./data/science.json?2.2.06'], textureImage: '../images/wallpapers/science.webp' });
  const Entertainment = new WordSetObject({ id: '8', emoji: '🍿', name: 'Entertainment', startsWithVowel: true, data: ['./data/entertainment.json?2.2.06'], textureImage: '../images/wallpapers/entertainment.webp' });
  const CommonEmoji = new WordSetObject({ id: '9', emoji: '✨', noLanguage: true, name: 'Emoji', startsWithVowel: true, data: ['./data/common-emoji.json?2.2.06'], scale: 1.8, wordAlignement: 'start', message: 'Some Emoji might not show on your device.', textureImage: '../images/wallpapers/emoji.webp' });
  ...
  const Adjectives = new WordSetObject({ id: '12', name: 'Adjectives', data: ['./data/adjectives.json?2.2.33'], textureImage: '../images/wallpapers/verbs.webp', enabled: false });
  const Interjections = new WordSetObject({ id: '13', name: 'Interjections', data: ['./data/interjections.json?2.2.33'], textureImage: '../images/wallpapers/verbs.webp', enabled: false });
  const NounsVerbsAdj = new WordSetObject({ id: '100', emoji: '🍎', name: 'Common', isSelected: true, data: [Nouns.data, Verbs.data, Adjectives.data], textureImage: '../images/wallpapers/common.webp' });
  const Seasons = new WordSetObject({ id: '101', emoji: '🍁', name: 'Seasons', data: [Winter.data, Spring.data, Summer.data, Fall.data], textureImage: '../images/wallpapers/seasons.webp' });
  const Civilization = new WordSetObject({ id: '102', emoji: '🌍', name: 'Civilization', data: ['./data/civilization.json?2.2.06'], textureImage: '../images/wallpapers/civilization.webp' });
  const Archeology = new WordSetObject({ id: '103', emoji: '🦴', name: 'Archeology', startsWithVowel: true, data: ['./data/prehistory.json?2.2.06'], textureImage: '../images/wallpapers/prehistory.webp', enabled: false });
  const Sports = new WordSetObject({ id: '104', emoji: '🏓', name: 'Sports', data: [Sport.data, Cities.data], textureImage: '../images/wallpapers/sports.webp' });
  const Kaomoji = new WordSetObject({ id: '105', scale: 0.8, emoji: '(☉_☉)', noLanguage: true, name: 'Kaomoji (¬_¬)', data: ['./data/kaomoji.json?2.2.06'], textureImage: '../images/wallpapers/emoji.webp' });
